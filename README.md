...
Check the [releases](https://github.com/droboports/mongoose/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/mongoose.git
cd mongoose
./build.sh
ls -la *.tgz
```
